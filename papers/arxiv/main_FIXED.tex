...
would naturally develop more sustainable attitudes and practices. Scaling this up to the level of every global citizen
adopting such a lifestyle is then considered by Prime Minister Narendra Modi to encompass a powerful instrument to
tackle climate change through “changing our lifestyle and creating consciousness,” and also a path to wellness that will
somehow make us better individuals in “thought, action, knowledge and devotion" (add citation).
...
cultural diplomacy and soft power. Scholars have argued that the initiative functions not only as a public health
campaign but also as a mechanism through which India projects cultural heritage, promotes wellness narratives, and
enhances its visibility within global public discourse \citep{softpower2020, advocacy2016}. At the same time, critical
scholars have examined the relationship between IDY, nationalism, identity politics, and state-sponsored cultural
narratives \citep{choreographing2020, unintended2018}.
...
of the International Day of Yoga} \citep{transformative2023}, \textit{Impact Assessment of International Day of Yoga}
\citep{impact2024}, and the Kolar conference proceedings \citep{kolar2015, kolar2016} emphasize health promotion,
participation, and wellness outcomes. In contrast, a smaller body of work has situated IDY within broader debates
concerning soft power, diplomacy, nationalism, and political symbolism. Notable examples include \textit{The
International Yoga Day, Political Discourse, and Soft Power Game in India} \citep{softpower2020}, \textit{Choreographing
Tolerance: Narendra Modi, Hindu Nationalism, and International Yoga Day} \citep{choreographing2020}, and \textit{The
Unintended Consequences of International Day of Yoga} \citep{unintended2018}.
...
Tolerance} \citep{choreographing2020}, examines the relationship between IDY and Hindu nationalism, while other highly
cited studies investigate the diplomatic and political dimensions of the initiative \citep{softpower2020,
unintended2018}. Consequently, the dominant publication profile of the field differs from the topics that have attracted
...
This study instead treats IDY discourse as an object of analysis.
...
standardization and differentiation of communication. Institutionalization theory further predicts that repeated events
stabilize into structured communicative regimes.


Applied to IDY, this implies increasing differentiation among discourse communities over time.
...
Computational approaches enable large-scale analysis of discourse structures across time. However, few studies have applied such methods to International Yoga Day.
...
\item Discourse Structure Index (DSI)

\item K-means clustering

\item ANOVA and Tukey HSD

\item Spearman correlation analysis

\item OLS regression with interaction terms

\item Mixed-effects regression models
...
\item H1: Discourse clusters differ significantly in DSI.

\item H2: DSI changes over time.

\item H3: Temporal trajectories differ across clusters.
...
\includegraphics[width=\textwidth]{figures/dsi_cluster_distribution.png}
...
\includegraphics[width=\textwidth]{figures/year_effects.png}
...
\includegraphics[width=\textwidth]{figures/mixed_effects.png}
...
\includegraphics[width=\textwidth]{figures/effect_sizes.png}
