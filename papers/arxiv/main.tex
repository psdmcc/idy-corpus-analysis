...
There is, however, a much smaller body of scholarship, which has focused more on critiquing IDY's instrumentalization into soft power, cultural diplomacy, nationalism, and political symbolism. For example, Gautam and Droogan argue that yoga functions as a significant component of India's soft-power strategy, enabling the projection of cultural influence through a globally recognizable practice \cite{gautam2018}. Likewise, Miller demonstrates how yoga discourse has been connected to wider narratives concerning climate change, self-care, and governance \cite{miller2020}. Similarly, Samal contextualizes IDY within India's international soft-power ambitions \cite{samal2020}. 

Critical scholarship also highlights tensions surrounding nationalism, authenticity, and the political uses of yoga. For example, Lakshmi argues that IDY constitutes an important site for nationalism and public culture to be both performed and negotiated \cite{lakshmi2020}. So too, McCartney's work similarly examines the intersections of yoga, nationalism, cultural authenticity, neoliberalism, and soft power, demonstrating how contemporary yoga movements frequently operate within broader political and ideological frameworks \cite{mccartney2018,mccartney2019a,mccartney2019b,mccartney2025,mccartney2026}. Combined, what these studies suggest is that IDY functions, not only as a public health initiative but, as a communicative arena within which multiple interpretations of culture, spirituality, citizenship, national identity, and global governance coexist and compete.
...
The first IDY occurred on 21 June 2015, after it was established by the UN's General Assembly in 2014. Early representations of the observance emphasized physical health, mental well-being, and social harmony. The Common Yoga Protocol (CYP), promoted internationally through governmental and diplomatic channels, has contributed to the standardization of annual celebrations and reinforced the presentation of yoga as a universal and accessible practice \cite{indiandiplomacy2017}.

As participation expanded internationally, IDY increasingly acquired diplomatic significance. Brought into the equation were governmental agencies, embassies, international organization, educational institutions, and media organizations. In coordination, they began incorporating yoga into broader narratives concerning cultural exchange, international cooperation, and global citizenship. Consequently, the observance developed beyond its original wellness orientation to become an important platform for cultural diplomacy and international engagement. However, perhaps the wellness orientation either inadvertantly developed or was purposely designed as a stepping stone toward greater global governance ambitions.
...
A custom Discourse Structure Index (DSI) was computed as the dependent variable, ascertaining a special communication score. This framework evaluates whether distinct communication groups, called Discourse Clusters (Independent Factor), discuss similar topics differently from one another. This approach first used a statistical test called a One-Way ANOVA (= analysis of variance).The One-Way ANOVA was deployed to evaluate the omnibus effect of cluster membership on DSI values, followed by a post-hoc Tukey HSD pairwise comparison to isolate specific inter-group variations.
