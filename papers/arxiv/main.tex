...
Aligned with H1, our empirical modeling provides robust evidence demonstrating that the identified discourse clusters are structurally partitioned, exhibiting highly significant differences in the Discourse Structure Index (DSI). The distribution of DSI values across the independent discourse communities is visualised in the boxplot distribution of Figure~\ref{fig:boxplot_distribution}, illustrating substantial rhetorical stratification across institutional environments. 
...
\begin{figure}[htbp]
    ...
    \label{fig:mixed_effects_chart}
\end{figure}

This progressive macro-level paradigm shift and structural alignment across institutional categories is empirically map-indexed across the broader bibliometric field in Figure~\ref{fig:pubmed_macro_trajectory}. It is clear the trend toward yogic informed sustainable governance has increased over time. While the increase in neuro-immunomodulation from 2019 onwards has also outpaced the more stable pulmonary therapeutic focus.
...
\begin{figure}[htbp]
    ...
    \label{fig:pubmed_macro_trajectory}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \label{fig:niche_axis_trajectory}
\end{figure}
