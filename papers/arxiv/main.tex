...
\title{From Ambient Gaze to Ambient Guruship: Mapping the Geopolitical and Ecological Architecture of State-Sponsored Yoga Literature Related to the International Day of Yoga}
...
\begin{abstract}
Since its inception in 2014, the International Day of Yoga (IDY) has served as a central pillar of India's soft-power statecraft, recently evolving from a localized health initiative into a comprehensive framework for global ecological stewardship via state directives like Mission LiFE. This paper analyzes this transition by tracking the emergence of what we term ``guru governmentality''---a political mechanism that transforms individual spiritual practices into decentralized tools for state-aligned citizenship. 

To map this phenomenon empirically, a dual-layer mixed-methods architecture – spanning the entire lifecycle of the IDY ecosystem (2014–2026) – is deployed. The primary corpus layer analyzes 1,758 policy artifacts anchored by a longitudinal core of 509 English-language YouTube broadcasts. This is cross-validated by a secondary bibliometric index of 7,978 peer-reviewed publication records extracted from the NIH PubMed database. By utilizing a text-contrast matrix to isolate non-clinical literature, we uncover a substantial structural expansion into state-directed domains, capturing 744 papers dedicated to Governance \& Policy and 309 papers focusing on Sustainability \& Ecology. 

Geopolitical tracing reveals that India holds an absolute institutional monopoly over this non-clinical output (driving 138 Governance and 37 Sustainability papers), proving that this academic pivot is an actively state-financed intellectual movement. Building upon McCartney and Louren\c{c}o's framework of the digital ``ambient gaze,'' we argue that this multi-centric media and scientific network has scaled into a mature manifestation of Copeman's ``ambient guru.'' By embedding civilizational rhetoric directly into global educational, healthcare, and environmental curricula, the state unmoors religious authority from physical constraints. The result is a disembodied, automated grid of state power that primes global audiences into state-prescribed standards of eco-citizenship and diplomatic alignment.

\keywords{Guru Governmentality \and Ambient Guru \and International Day of Yoga \and Mission LiFE \and Bibliometrics \and Digital Discourse}
\end{abstract}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/yoga_trends_2014_2026.png}
    \caption{Absolute Trajectory of Total Indexed PubMed Yoga Literature (2014–2026). While clinical frameworks maintain a predictable numerical dominance, the continuous outward expansion of socio-political terminology captures the primary baseline of an ambient discursive field mutating away from localized rehabilitation.}
    \label{fig:yoga_trends_macro}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/niche_growth_trajectory.png}
    \caption{Dual-Axis Trajectory of Isolated Governance ($n=744$) vs. Sustainability ($n=309$) Literatures. By stripping out clinical background noise, this visualization illustrates that the Indian state's ambient signal does not expand uniformly. Rather, Governance exhibits a sharp pandemic-era acceleration, whereas Sustainability shows a clear, post-2021 upward trajectory.}
    \label{fig:niche_growth_trajectory}
\end{figure}

\begin{table}[htbp]
\centering
\caption{Geographic Footprint and Institutional Hubs in Non-Clinical Yoga Literature}
\label{tab:geo_origins}
\small
\begin{tabular}{lrc@{\hspace{2em}}lr}
\toprule
\multicolumn{2}{c}{\textbf{Governance \& Policy Sub-Corpus}} & & \multicolumn{2}{c}{\textbf{Sustainability \& Ecology Sub-Corpus}} \\
\cmidrule{1-2} \cmidrule{4-5}
\textbf{Country of Origin} & \textbf{Count} & & \textbf{Country of Origin} & \textbf{Count} \\
\midrule
India          & 138 & & India          &  37 \\
United States  &  28 & & United States  &  10 \\
United Kingdom &  10 & & United Kingdom &   6 \\
Brazil         &   7 & & China          &   3 \\
Germany        &   5 & & Australia      &   3 \\
\bottomrule
\end{tabular}
\end{table}
...
This mechanism is best understood by tracking the conceptual evolution from the macro-level \textit{ambient gaze} theorized by McCartney and Louren\c{c}o (2025) to the broader algorithmic framework of the \textit{ambient guru} advanced by Copeman (2026). McCartney and Louren\c{c}o originally demonstrated that non-human material objects and digital media arrays can function as ubiquitous, interlinked nodes that broadcast a guru's continuous spatial attention---behaving less like a localized person and more like an omnipresent ``Wi-Fi signal'' that conditions practitioner behaviors and signals unbridled social distinction.

When mapped onto the longitudinal IDY and NIH bibliometric data, this ambient architecture undergoes a profound technological and political upgrade, scaling into a mature manifestation of Copeman’s (2026) ``ambient guru,'' which is advanced by Copeman's \textit{GuruAI: The Global Anthropology of the Transformation of Guruship in the Age of Artificial Intelligence}. Here, the traditional boundaries of religious authority are completely unmoored from physical proximity or biological containment. The 7,978 papers mined from the NIH index serve as the literal infrastructure of this disembodied grid \cite{IDEGA2026}. 

When the text-contrast matrix strips away the clinical background noise, the phrases that rise to the top---``School-Based,'' ``Medical Education,'' ``Environmental Factors,'' and ``Climate Change''---expose how the ambient guru operates. As empirically verified by the dual-axis growth curves in Figure~\ref{fig:niche_growth_trajectory} and the absolute domination of Indian institutional hub data in Table~\ref{tab:geo_origins}, the multi-centric media network effectively automates the guru-disciple dynamic at a geopolitical scale. 

By weaving state directives directly into international health, educational, and environmental curricula, the disembodied network transforms a centralized state-branding initiative into an ambient, everyday social environment. The global audience is thus subtly primed into state-prescribed standards of citizenship and diplomatic alignment, demonstrating how code, media interfaces, and distributed narrative structures can successfully institutionalize an ambient political theology across the digital world.
...
The 7,978 papers mined from the NIH index serve as the literal infrastructure of this "disembodied grid." When the text-contrast matrix strips away the clinical background noise, the phrases that rise to the top – "School-Based," "Medical Education," "Environmental Factors," and "Climate Change" — expose how the ambient guru operates. The grid embeds state directives directly into international health, educational, and environmental curricula. The individual practicing a "school-based" breathing protocol for "emotion regulation" is no longer just engaging in self-care. They are behaving as a node inside a distributed panopticon of state power, fulfilling the biopolitical mandates of an ambient, everyday social environment automated by code, media interfaces, and institutionalized narrative structures.
